...
process DGE_BY_DESEQ2 {
  ...
  publishDir "${params.publishDirPath}/${params.deseq2NormPath}", pattern: "norm_counts_output/*", saveAs:{ filename -> filename.getName()}
  publishDir "${params.publishDirPath}/${params.deseq2DgePath}", pattern: "dge_output/*", saveAs:{ filename -> filename.getName()}
