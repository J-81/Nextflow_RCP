...
params:
    ...
    organisms_csv: NULL # Path of assets files that supplies organism metadata for gene annotation mapping
    organism: NULL # Determines row of organisms.csv to use.
---
...
# reading organisms.csv table
org_table <- read.table(params$organisms_csv, sep = ",", header = TRUE)
# getting link to annotations table
